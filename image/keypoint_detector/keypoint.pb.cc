...
void protobuf_AssignDesc_keypoint_2eproto() {
  protobuf_AddDesc_keypoint_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_keypoint_2eproto);
}
...
void protobuf_AddDesc_keypoint_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_keypoint_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_keypoint_2eproto {
  StaticDescriptorInitializer_keypoint_2eproto() {
    protobuf_AddDesc_keypoint_2eproto();
  }
} static_descriptor_initializer_keypoint_2eproto_;
...
#ifndef _MSC_VER
const KeypointProto_KeypointType KeypointProto::HAAR;
...
const KeypointProto_Location& KeypointProto_Location::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_keypoint_2eproto();  return *default_instance_;
}
