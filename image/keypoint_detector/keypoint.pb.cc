...
void protobuf_AddDesc_image_2fkeypoint_5fdetector_2fkeypoint_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\001 \003(\0132\024.theia.KeypointProto", 427);
...
const KeypointProto_Location& KeypointProto_Location::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_image_2fkeypoint_5fdetector_2fkeypoint_2eproto();  return *default_instance_;
}
