...
#=============================================================================
# Copyright 2013 Chris Sweeney <cmsweeney@cs.ucsb.edu>
...
function(PROTOBUF_GENERATE_CPP SRCS HDRS)
  ...
  foreach(FIL ${ARGN})
    ...
    add_custom_command(
      ...
      ARGS --cpp_out  ${CMAKE_CURRENT_SOURCE_DIR} --include_imports ${_protobuf_include_path} ${ABS_FIL}
      DEPENDS ${ABS_FIL}
      COMMENT "Running Chris' C++ protocol buffer compiler on ${FIL}"
      VERBATIM )
  endforeach()
